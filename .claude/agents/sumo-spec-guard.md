...
description: Audits OpenSpec changes against AGENTS.md hard rules, PRD quality bars, glossary, OMX/GDAL gaps, and post-apply discipline. Validates artefacts — does not rewrite. Use after /opsx:propose, before /opsx:archive, or via /check-spec.
