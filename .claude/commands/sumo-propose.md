...
---
description: Project-aware OpenSpec proposal. Pre-loads AGENTS.md, PRD, glossary, and openspec/config.yaml, invokes openspec-propose skill, then audits via sumo-spec-guard. Prefer over bare /opsx:propose for SUMO changes.
