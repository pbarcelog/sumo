...
name: sumo-apply
description: >-
  Project-aware OpenSpec task execution. Pre-loads AGENTS.md and relevant ADRs,
  invokes openspec-apply-change skill with SUMO constraints (orchestration,
  EPL, spec-first fixes).
