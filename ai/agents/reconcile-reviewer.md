...
description: >-
  Reviews cross-slice consistency of glossary, interfaces, and ADRs after
  reconciliation passes (R1, R2). Use after every 3–4 slice passes.
activation_phrase: "Act as Reconcile Reviewer"
