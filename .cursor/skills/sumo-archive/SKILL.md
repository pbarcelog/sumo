...
name: sumo-archive
description: >-
  Project-aware OpenSpec archive. Runs sumo-spec-guard in gate mode before /opsx:archive. Updates specs/adr-registry.md and specs/coverage.md when applicable.
---
# SUMO Archive
